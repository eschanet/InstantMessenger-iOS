...
@interface ESSelectMultipleView()
{
    /**
...
/**
 *  Searchbar used to search for specific users
 */
@property (strong, nonatomic) IBOutlet UISearchBar *searchBar;

@end

@implementation ESSelectMultipleView

@synthesize delegate,searchBar,viewHeader;
...
- (void)searchUsers:(NSString *)search
{
    ...
    [query2 whereKey:kESUserFullnameLower equalTo:[search lowercaseString]];
