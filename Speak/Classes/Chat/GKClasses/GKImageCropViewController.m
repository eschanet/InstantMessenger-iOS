...
- (void)_setupCancelButton{
    ...
    if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_6_1) {
        ...
        [self.cancelButton.titleLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:16]];
...
- (void)_setupUseButton{
    ...
    if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_6_1) {
        ...
        [self.useButton.titleLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:16]];
