...
- (BOOL)isEqual:(id)object
{
	...
	ESVideoMediaItem *videoItem = (ESVideoMediaItem *)object;
...
{
	ESVideoMediaItem *copy = [[[self class] allocWithZone:zone] initWithFileURL:self.fileURL isReadyToPlay:self.isReadyToPlay];
