...
- (UIView *)mediaView
{
	...
	if (self.cachedAudioImageView == nil)
	{
		...
		UIColor *colorBackground = outgoing ? kESMessageColorOut : kESMessageColorIn;
...
- (BOOL)isEqual:(id)object
{
	...
	ESAudioMediaItem *audioItem = (ESAudioMediaItem *)object;
...
{
	ESAudioMediaItem *copy = [[[self class] allocWithZone:zone] initWithFileURL:self.fileURL Duration:self.duration];
