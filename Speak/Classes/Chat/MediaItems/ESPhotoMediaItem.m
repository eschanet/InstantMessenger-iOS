...
@interface ESPhotoMediaItem()

@property (strong, nonatomic) UIImageView *cachedImageView;

@end

@implementation ESPhotoMediaItem
...
{
	ESPhotoMediaItem *copy = [[[self class] allocWithZone:zone] initWithImage:self.image Width:self.width Height:self.height];
