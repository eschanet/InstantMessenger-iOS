...
\index{did\+Present\+Error\+With\+Recovery\+:context\+Info\+:@{did\+Present\+Error\+With\+Recovery\+:context\+Info\+:}!F\+B\+S\+D\+K\+Graph\+Error\+Recovery\+Processor@{F\+B\+S\+D\+K\+Graph\+Error\+Recovery\+Processor}}
...
\index{process\+Error\+:request\+:delegate\+:@{process\+Error\+:request\+:delegate\+:}!F\+B\+S\+D\+K\+Graph\+Error\+Recovery\+Processor@{F\+B\+S\+D\+K\+Graph\+Error\+Recovery\+Processor}}
...
\index{delegate@{delegate}!F\+B\+S\+D\+K\+Graph\+Error\+Recovery\+Processor@{F\+B\+S\+D\+K\+Graph\+Error\+Recovery\+Processor}}
