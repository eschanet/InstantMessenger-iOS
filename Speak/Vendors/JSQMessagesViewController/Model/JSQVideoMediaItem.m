...
@implementation JSQESVideoMediaItem
...
- (BOOL)isEqual:(id)object
{
    ...
    JSQESVideoMediaItem *videoItem = (JSQESVideoMediaItem *)object;
...
{
    JSQESVideoMediaItem *copy = [[[self class] allocWithZone:zone] initWithFileURL:self.fileURL
