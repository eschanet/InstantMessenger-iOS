...
const CGFloat kJSQMessagesLoadEarlierHeaderViewHeight = 44.0f;
...
- (void)awakeFromNib
{
    ...
    self.loadButton.backgroundColor = [UIColor colorWithWhite:0.97 alpha:1];
    self.loadButton.layer.cornerRadius = 5;
    self.loadButton.layer.borderColor = [UIColor colorWithWhite:0.9 alpha:1].CGColor;
    self.loadButton.layer.borderWidth = 0.5;
}
